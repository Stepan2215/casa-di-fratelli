export default function EventsSection({ language }) {
  return (
    <section id="events" className="relative mx-auto max-w-7xl overflow-hidden px-6 py-20">
      ...
      <div className="relative grid items-stretch gap-6 md:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="menu-spark rounded-[30px] border border-[#c9a56a]/18 bg-[linear-gradient(135deg,rgba(201,165,106,0.18),rgba(255,255,255,0.045)),radial-gradient(circle_at_78%_18%,rgba(244,63,94,0.18),transparent_16rem)] p-7 shadow-2xl shadow-black/25 md:p-9">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={item} className="rounded-2xl border border-white/10 bg-black/20 p-4 text-sm font-semibold text-white/82">
                {item}
              </div>
            ))}
          </div>
